...
//	private static void AddPassword(HashMap<String, Integer> Password, String password ,int Password_Count, String file) {
//		Password.putIfAbsent(password, Password_Count);
//		if(Password.size() != Password_Count) {
////				fw.write(password);
////				fw.write("\n");	
//				Password_Count++;
//		} 
